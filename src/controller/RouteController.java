...
public class RouteController {
	...
	public List<RouteDetails> findRoutes(String fromCity, String toCity, OptimizationCriteria criteria) {
	    try {
	        System.out.println("=== ROUTE FINDER DEBUG ===");
	        System.out.println("Finding routes from " + fromCity + " to " + toCity + " with criteria: " + criteria);
	        
	        List<PathInfo> pathInfos = routeFinder.findRoutes(fromCity, toCity, criteria, 5);
	        currentRoutes = convertPathInfosToRouteDetails(pathInfos);
	        ...
	        for (int i = 0; i < currentRoutes.size(); i++) {
	            ...
	            System.out.println("Route " + (i+1) + ": " + route.getFormattedTotalTime() + 
	                             ...
	                             " | Weight: " + route.getTotalWeight());  // ← Add this line
	        }
...
//	}
//
//	private List<RouteDetails> convertToRouteDetails(List<PathInfo> pathInfos) {
//		List<RouteDetails> routeDetailsList = new ArrayList<>();
//		for (PathInfo pathInfo : pathInfos) {
//			routeDetailsList.add(new RouteDetails(pathInfo));
//		}
...
//	public List<RouteDetails> findRoutes(String fromCity, String toCity, OptimizationCriteria criteria) {
//		try {
//			// FIXED: routeFinder.findRoutes() now returns List<PathInfo> instead of
//			// List<Path>
//			List<PathInfo> pathInfos = routeFinder.findRoutes(fromCity, toCity, criteria, 5);
//			currentRoutes = convertToRouteDetails(pathInfos);
//			return currentRoutes;
//		} catch (Exception e) {
//			System.err.println("Error finding routes: " + e.getMessage());
//			e.printStackTrace();
