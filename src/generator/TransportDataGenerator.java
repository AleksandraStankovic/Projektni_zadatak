...
// 
//    //konstrukor, jer final polja moraju biti inicijalizovana I guss. Javadoc za ovo
//    public TransportDataGenerator (int rows, int cols)//preuzecemo iz prozora kod unosa
//    {
//    	this.rows=rows;
//    	this.cols=cols;
//    }
    ...
    //i guess da ovo radi, pogledati sutra tacno da li je dobro i kako tacno funkcionise
