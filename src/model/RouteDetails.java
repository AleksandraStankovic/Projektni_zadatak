...
/**
 * Represents detailed information about a route, including the path, total
 * travel time, cost, number of transfers, and individual route segments.
 *
 * <p>
 ...
 * {@code RouteSegment} objects, or directly from a {@code Path} with zeroed
 * statistics.
 * </p>
 *
 * <p>
...
public class RouteDetails {
	...
	public RouteDetails(PathInfo pathInfo) {
		...
		if (path != null) {
			...
			path.getEdgeSet().forEach(edge -> {
				...
				String departure = edge.getAttribute("departureStr") != null
						? (String) edge.getAttribute("departureStr")
						: null;
	...
	public String toString() {
		return "Time: " + getFormattedTotalTime() + " | Cost: " + getFormattedTotalCost() + " | Transfers: "
				+ totalTransfers;
	}
}
