...
@JsonSubTypes({ @JsonSubTypes.Type(value = BusStation.class, name = "autobus"),
 ...
 * The {@code type} property in JSON indicates the concrete subclass: "autobus"
 * for BusStation and "voz" for TrainStation.
 * </p>
 *
 * <p>
 * Each station stores the city it belongs to and a unique station code.
 * Subclasses must implement the {@code getType()} method to indicate the type
 * of station.
 * </p>
 */
