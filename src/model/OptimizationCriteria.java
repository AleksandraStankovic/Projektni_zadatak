 ...
 *
 * <p>
 * Each enum constant has a display name in a user-friendly format. Utility
 * methods are provided to get the display name and to convert from a display
 * name string back to an enum constant.
 * </p>
 */
